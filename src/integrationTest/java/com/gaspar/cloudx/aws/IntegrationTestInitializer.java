...
public class IntegrationTestInitializer {
    ...
    private static final String MOCK_BUCKET_NAME = "cloudx-book-cover-images";
    private static final String MOCK_TABLE_NAME = "CloudxBookData";
    private static final String MOCK_CUSTOMER_TABLE_NAME = "CloudxCustomerData";
    private static final String MOCK_TOPIC_NAME = "cloudx-book-notifications";
    ...
    public static void props(DynamicPropertyRegistry registry) {
        ...
        registry.add("logging.level.com.gaspar.cloudx.aws", () -> "DEBUG");
